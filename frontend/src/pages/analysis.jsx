							...
							<div className='flex flex-row'>
								{daily.map((day) => (
									<div
										...
										className={
											selected === day
												? 'px-4 py-3 rounded-full text-center bg-overLay mx-1'
												: 'px-4 py-3 rounded-full text-center bg-darkGray  mx-1'
										}
										key={day.id}>
										<div
											onClick={() => toggle(day)}
				...
				<div className='flex flex-col space-y-4  justify-evenly '>
					<div className='h-72 w-36 bg-darkGray rounded-lg'>
						<div className='absolute'>
							<img
								src={Stock}
								className='h-72 w-36 rounded-lg'
								alt=''
							/>
						</div>
						...
						<div className='relative flex flex-col mt-5  '>
							...
							<p className='text-xl text-center pt-4 text-white'>
								{sel.stockAmount}
							</p>
						</div>
					</div>
					<div className='h-60 w-36 bg-darkGray rounded-lg'>
						<div className='absolute'>
							<img
								src={Crypto}
								className='h-60 w-36 rounded-lg'
								alt=''
							/>
						</div>
						<div className='relative p-2 border-b-2 border-lightGray'>
				...
				<div className='flex flex-col space-y-4  justify-evenly'>
					<div className='h-60 w-36 bg-darkGray rounded-lg'>
						...
						<div className='relative flex flex-col mt-5  '>
							...
							<p className='text-xl text-center pt-4 text-black'>
								{sel.cryptoAmount}
							</p>
						</div>
					</div>
